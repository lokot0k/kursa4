...
export default function OurWorkSection() {
  return (
    <div className={styles.ourWorkSection__mainWrap}>
      <h1 className={styles.ourWorkSection__header}>Наши работы</h1>
