    ...
    return (
        <>
            ...
            <div className={styles.topSection__controlsWrap}>
                ...
                >
                    <span>Получить консультацию вы можете по телефону<br /><b>+7 917 237 65 20</b></span>
                    <span>ПОЗВОНИТЬ</span>
                </div>
                <div
            ...
            <div className={styles.contacts}>
                ...
                <div className={styles.icons}>
                    <a href={"https://t.me/promkomsnab"} target={"_blank"}>
                        <img style={{width: "40px", height: "40px", marginTop: "-8px"}} src={icon1}></img>
                    </a>
                    <a href={"https://www.instagram.com/promkomsnab.ru/"} target={"_blank"}>
                        <img style={{width: "40px", height: "40px", marginTop: "-8px", marginLeft:"10px"}} src={icon2}></img>
                    </a>
                </div>
