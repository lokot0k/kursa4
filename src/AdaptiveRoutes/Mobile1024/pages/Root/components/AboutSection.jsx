            ...
            <div className={styles.aboutSection__columnBlock}>
                <div className={styles.aboutSection__column}>
                    ...
                    <div className={styles.aboutSection__blockWrapper}>
                        <h1 className={styles.aboutSection__subHeader}>Николаева Ольга — основатель и директор компании «ПромКомСнаб»</h1>
                        <br /><hr /><br />
                    ...
                    <video className={styles.aboutSection__video1} src={video1} autoPlay loop muted></video>
                    <img className={styles.aboutSection__img} src={img2}></img>
                    <img className={styles.aboutSection__img} src={grad1}></img>
                </div>
                <div className={styles.aboutSection__column}>
                    ...
                    <video className={styles.aboutSection__video2} src={video2} autoPlay loop muted></video>
                    <div className={styles.aboutSection__blockWrapper}>
                        <h1 className={styles.aboutSection__subHeader}>Как правильно подобрать водоотводные лотки и разработать эффективную систему поверхностного водоотведения?</h1>
                        <br /><hr /><br />
                        <div className={styles.aboutSection__textBlock}>
                            <p>
