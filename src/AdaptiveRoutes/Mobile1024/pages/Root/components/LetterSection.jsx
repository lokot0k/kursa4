    ...
    return(
        <>
            ...
            <div className={styles.letters__textWrap}>
                <span className={styles.letters__text}>Успех нашей компании во многом объясняется тем, что мы придерживаемся принципа открытости и честности по отношению к своим клиентам и партнерам.
<br/>
<br/>
