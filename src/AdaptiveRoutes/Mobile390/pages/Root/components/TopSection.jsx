  ...
  return (
    <>
      ...
      <div className={styles.topSection__contacts}>
        <p>
          <span>Казань, ул.Летова, д.17  </span>
          <span>+7 9172376520</span>
      ...
      <div className={styles.topSection__descriptionWrap}>
        ...
        Компания «ПромКомСнаб» работает в сфере проектирования и поставок систем поверхностного водоотведения. Мы
        предоставляем комплексные решения задач по организации сбора и отвода ливневых и талых вод, а именно
        проектирование, поставка и шеф-монтаж систем поверхностного водоотвода.
      </div>
        ...
        {/* <div className={styles.topSection__workWrap1}>
                ...
                <div className={styles.topSection__workWrap2}>
                    <div className={styles.topSection__work21}>
                        <span>Набережная Марка Шагала, г.Москва</span>
                        Пластиковый сток
